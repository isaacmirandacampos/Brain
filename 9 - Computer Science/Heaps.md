**Target:** [USP - Heap][https://eaulas.usp.br/portal/video?idItem=15846]
**Created:** 2023-12-17 14:18
...
No min heap, Uma forma de encontrar os indices filhos de um valor é usando a seguinte formula, o elemento da posição *i* é menor ou igual aos elementos das posições 2i e 2i + 1
![[exemplo de min heap.png]] 
...
![[exemplo de como encontrar o indice do pai na estrutura heap.png]]
...
![[1 - exemplo de como resolver casos de violação das regras na estrutura de dados heap.png]]
![[2 - exemplo de como resolver casos de violação das regras na estrutura de dados heap.png]]
...
![[1 - exemplo de vetor sendo refatorado para uma estrutura max heap.png]]
![[2 - exemplo de vetor sendo refatorado para uma estrutura max heap.png]]
![[3 - exemplo de vetor sendo refatorado para uma estrutura max heap.png]]
![[4 - exemplo de vetor sendo refatorado para uma estrutura max heap.png]]
![[5 - exemplo de vetor sendo refatorado para uma estrutura max heap.png]]
![[6 - exemplo de vetor sendo refatorado para uma estrutura max heap.png]]
![[7 - exemplo de vetor sendo refatorado para uma estrutura max heap.png]]
*A partir dai o algoritmo continua sendo executado até que a estrutura esteja totalmente sem violações*

Exemplo de código que faz o passo a passo anterior:
```python
...
![[Outras propriedades da estrutura heap.png]]
