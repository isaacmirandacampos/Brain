**Target:** [USP - Mergesort](https://eaulas.usp.br/portal/video?idItem=20198)
**Created:** 2023-12-26 09:18
**Keywords:** #algorithm #performance #learning #computer 

## What is it?
The merge sort is an ordering algorithm, from divider to conqueror.
## How it work?
In the next image, you can see how it works.
![[01 - mergesort explained.png]]
### How to use in code?
```python
